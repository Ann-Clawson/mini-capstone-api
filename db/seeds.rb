User.create!([
  { name: "Eno", email: "Eno@eno", password: "password", admin: false },
  { name: "Jens", email: "Jens@jens.com", password: "password", admin: false },
  { name: nil, email: "Eno@eno.com", password: "password", admin: true },
  { name: "Tina", email: "Tina@tina.com", password: "password", admin: false },
  { name: "Me", email: "Me@me.com", password: "password", admin: true },
])
Supplier.create!([
